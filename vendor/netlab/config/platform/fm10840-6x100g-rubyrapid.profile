# NetLab platform profile for the FM10840 / rubyRapid 6x100G platform.
#
...
platform model=FM10840 chassis-name=RubyRapid-6x100G serial=FM10840-RUBYRAPID-6X100G system-name=NetLab-FM10840 system-description="NetLab FM10840 rubyRapid 6x100G switch" system-mac=02:00:00:10:84:00 max-ae=8 rstp-bridge-priority=32768 rstp-hello-sec=2 rstp-bpdu-stale-sec=180 lacp-system-priority=32768 lacp-port-priority=32768 lacp-ttl-sec=90
...
# This 6x100G profile uses the corrected split configuration where user-facing
# line/default speed and SDK scheduler speed are all 100G.
port name=et-0/0/0 interface-id=1001 media=et fpc=0 pic=0 port=0 switch-index=0 port-index=1 logical-port=1 front-panel-port=1 role=external interface-type=QSFP_LANE0 ethernet-mode=100GBase-SR4 capabilities=LAG,40G,100G hw-resource-id=0 epl-port=0 lane=0 default-speed=100000000000 line-rate=100000000000 scheduler-speed=100000000000 supported-speeds=40000000000,100000000000 rstp-cost=1 flags=external,trunk,lldp-default,rstp,lacp
port name=et-0/0/1 interface-id=1002 media=et fpc=0 pic=0 port=1 switch-index=0 port-index=2 logical-port=2 front-panel-port=2 role=external interface-type=QSFP_LANE0 ethernet-mode=100GBase-SR4 capabilities=LAG,40G,100G hw-resource-id=1 epl-port=1 lane=0 default-speed=100000000000 line-rate=100000000000 scheduler-speed=100000000000 supported-speeds=40000000000,100000000000 rstp-cost=1 flags=external,trunk,lldp-default,rstp,lacp
port name=et-0/0/2 interface-id=1003 media=et fpc=0 pic=0 port=2 switch-index=0 port-index=3 logical-port=3 front-panel-port=3 role=external interface-type=QSFP_LANE0 ethernet-mode=100GBase-SR4 capabilities=LAG,40G,100G hw-resource-id=2 epl-port=2 lane=0 default-speed=100000000000 line-rate=100000000000 scheduler-speed=100000000000 supported-speeds=40000000000,100000000000 rstp-cost=1 flags=external,trunk,lldp-default,rstp,lacp
port name=et-0/0/3 interface-id=1004 media=et fpc=0 pic=0 port=3 switch-index=0 port-index=4 logical-port=4 front-panel-port=4 role=external interface-type=QSFP_LANE0 ethernet-mode=100GBase-SR4 capabilities=LAG,40G,100G hw-resource-id=3 epl-port=5 lane=0 default-speed=100000000000 line-rate=100000000000 scheduler-speed=100000000000 supported-speeds=40000000000,100000000000 rstp-cost=1 flags=external,trunk,lldp-default,rstp,lacp
port name=et-0/0/4 interface-id=1005 media=et fpc=0 pic=0 port=4 switch-index=0 port-index=5 logical-port=5 front-panel-port=5 role=external interface-type=QSFP_LANE0 ethernet-mode=100GBase-SR4 capabilities=LAG,40G,100G hw-resource-id=4 epl-port=6 lane=0 default-speed=100000000000 line-rate=100000000000 scheduler-speed=100000000000 supported-speeds=40000000000,100000000000 rstp-cost=1 flags=external,trunk,lldp-default,rstp,lacp
port name=et-0/0/5 interface-id=1006 media=et fpc=0 pic=0 port=5 switch-index=0 port-index=6 logical-port=6 front-panel-port=6 role=external interface-type=QSFP_LANE0 ethernet-mode=100GBase-SR4 capabilities=LAG,40G,100G hw-resource-id=5 epl-port=7 lane=0 default-speed=100000000000 line-rate=100000000000 scheduler-speed=100000000000 supported-speeds=40000000000,100000000000 rstp-cost=1 flags=external,trunk,lldp-default,rstp,lacp
